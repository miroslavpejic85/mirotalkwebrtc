...
const dsEvents = document.getElementById('dsEvents');
...
['booking-room-type', 'event-room-type'].forEach((id) => {
...
const getMode = document.documentElement.dataset.theme;
