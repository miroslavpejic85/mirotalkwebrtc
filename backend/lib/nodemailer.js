...
function sendInvitationEmail(name, email, setupUrl) {
    return transport.sendMail({
        ...
        text: `Hello ${name},\n\nAn account has been created for you.\n\nUsername: ${name}\nEmail: ${email}\n\nChoose your password using this secure, single-use link:\n${setupUrl}\n\nThis link expires in 1 hour.`,
        html: buildEmailHtml({
            preheader: 'Finish setting up your new MiroTalk account.',
            title: 'You have been invited',
            greeting: `Hello ${name},`,
            content: `<p style="margin:0;line-height:1.6;">An account has been created for you. Use the username below to sign in after choosing your password.</p><p style="margin:20px 0 0;padding:14px 16px;background:#f8fafc;border-left:4px solid #2457d6;line-height:1.7;"><strong>Username:</strong> ${escapeHtml(name)}<br/><strong>Email:</strong> ${escapeHtml(email)}</p><p style="margin:20px 0 0;font-size:13px;line-height:1.6;color:#5e6878;">This secure link expires in 1 hour and can only be used once.</p>`,
